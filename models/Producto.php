<?php
    ...
    class Producto extends Conectar{
        ...
        public function insert_producto($prod_nom, $prod_desc){
            ...
            $conectar = parent::conexion();
            //parent::set_names();
            $sql = "INSERT INTO tm_producto (prod_id, prod_nom, prod_desc,fech_crea, fech_mod, fech_elim, est)
                    VALUES 
        ...
        public function update_producto($prod_id, $prod_nom, $prod_desc){
            ...
            $conectar = parent::conexion();
            //parent::set_names();
            $sql = "UPDATE tm_producto SET prod_nom = ?, prod_desc = ?, fech_mod = now() WHERE prod_id = ?";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $prod_nom);
            $sql->bindValue(2, $prod_desc);
